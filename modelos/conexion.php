...
abstract class Conexion{
    ...
    protected static function connectar() : PDO{
        try {
            ...
            self::$conexion = new PDO("informix:host=host.docker.internal; service=9088;database=hospitallaesperanza; server=informix; protocol=onsoctcp;EnableScrollableCursors=1", "informix", "in4mix");
