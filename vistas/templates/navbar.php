<nav class="navbar fixed-top navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="../../vistas/cliente/index.php"><img src="../../src/images/logo.jpg" alt="Logo" width="70" height="70">HOSPITAL</a>
      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="../../vistas/cliente/buscar.php"><i class="bi bi-search me-2"></i>BUSCAR</a></li>
          </ul>
        </li>
    </div>
  </div>
